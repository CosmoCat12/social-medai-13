...
export const ProfilePage = () => {
  ...
  //* isError - Статус есть ли ошибка или нет возвращает boolean значение (true/false)
  //* isLoading - Статус загрузки или нет возвращает boolean значение (true/false)
  //* error - Объект ошибки, если есть возвращает ошибку
  //* isSuccess - Статус успешной загрузки или нет возвращает boolean значение (true/false)
        ...
        <div className="user__block">
          ...
          <div className="user__description">
            <h1 className="user__name">
              {isSignedIn ? user.fullName : data?.message.name}
            </h1>
