...
import FriendsBlock from "../../components/FreindsBlock/FriendsBlock";
import ProfileHeader from "../../components/ProfileHeader/ProfileHeader";
import { useGetAllPostsQuery } from "../../store/api/postApi";
import Post from "../../components/Post/Post";
import { IPost } from "../../store/api/types";
import CreatePostForm from "../../components/forms/CreatePostsForm";
    ...
    <SCProfilePage>
      ...
      <main className="Main">
        ...
        {filteredPosts ? (
          ...
          <Heading variant="h2" text="У вас пока не постов" />
        )}
      </main>
